...
const { buildConfigItems, getPluginActions } = require("../../dist/loader/plugins.js");
...
describe("plugins: the diagnostics screen's keys and its hint", () => {
  ...
  it("dismisses on esc and on enter", () => {
    const { handlePluginKey } = require("../../dist/loader/input.js");
  ...
  it("advertises exactly what its keys do", () => {
    const { buildPlugins } = require("../../dist/loader/views/plugins.js");
    openDiagnostics();
    const foot = [];
