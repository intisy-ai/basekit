...
const seam = require("../../dist/loader/activity-seam.js");
...
describe("spawn env merge", () => {
  ...
  describe("the manager child is told which app it acts on", () => {
    it("passes the injected app id through to spawn", () => {
      ...
      try {
        const S = require("../../dist/loader/state.js").S;
        const updater = require("../../dist/loader/updater.js");
    ...
    it("the compiled source does not make PLUGIN_UPDATER_APP conditional", () => {
      const source = readFileSync(new URL("../../dist/loader/updater.js", import.meta.url), "utf8");
