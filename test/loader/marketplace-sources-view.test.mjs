...
const { sourceRowsFrom, fetchSourceCatalogAsync } = require("../../dist/loader/marketplace.js");
...
const { buildMarketplaceMarketsList } = require("../../dist/loader/marketplace.js");
...
const { buildMarketplacePluginsList } = require("../../dist/loader/marketplace.js");
